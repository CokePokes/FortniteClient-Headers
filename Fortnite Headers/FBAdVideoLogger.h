...
@class FBAdQualityManager, NSDictionary, NSString, NSURL, UIView;
...
@property(readonly, nonatomic) NSURL *loggingURL; // @synthesize loggingURL=_loggingURL;
...
@property(retain, nonatomic) NSString *inlineClientToken; // @synthesize inlineClientToken=_inlineClientToken;
...
- (id)initWithTargetView:(id)arg1 loggingURL:(id)arg2 autoplay:(_Bool)arg3;
