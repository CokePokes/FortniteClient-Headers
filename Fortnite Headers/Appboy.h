...
@class ABKFeedController, ABKInAppMessageController, ABKLocationManager, ABKManager, ABKPersistentData, ABKPlaceIQManager, ABKPushNotificationManager, ABKSessionManager, ABKTriggerManager, ABKUser, NSString;
...
+ (id)unsafeInstance;
+ (id)sharedInstance;
@property(retain) ABKPlaceIQManager *placeIQManager; // @synthesize placeIQManager=_placeIQManager;
