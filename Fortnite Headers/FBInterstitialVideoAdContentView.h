...
@class FBAdChoicesView, FBAdTimer, FBAdVideoPlayButton, FBInstreamAdChoicesIcon, FBInstreamAdVideoView, FBInstreamLearnMoreView, FBInstreamSkipButtonView, FBVideoAdLabel, NSString, UIView, UIViewController;
...
@property(retain, nonatomic) FBAdVideoPlayButton *playPauseButton; // @synthesize playPauseButton=_playPauseButton;
...
@property(nonatomic) NSString *callToActionText; // @synthesize callToActionText=_callToActionText;
@property(nonatomic) _Bool controlsVisible; // @synthesize controlsVisible=_controlsVisible;
@property(retain, nonatomic) FBAdTimer *controlsHideTimer; // @synthesize controlsHideTimer=_controlsHideTimer;
...
@property(retain, nonatomic) UIView *adChoicesContainer; // @synthesize adChoicesContainer=_adChoicesContainer;
- (void).cxx_destruct;
